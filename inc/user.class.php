         ...
         if ($item->canView()) {
            ...
            if ($DB->numrows($result) > 0) {
              ...
              //   var_dump($data);
                  ...
                  $show = "<td class='center'>".Dropdown::getDropdownName("glpi_plugin_genericobject_motherboardmodels",
                          $data["plugin_genericobject_motherboardmodels_id"]).
                          Dropdown::getDropdownName("glpi_monitormodels",$data["monitormodels_id"]).
                          Dropdown::getDropdownName("glpi_plugin_genericobject_videocardmodels",$data["plugin_genericobject_videocardmodels_id"]).
                 ...
                 echo "<td class='center'>".Dropdown::getDropdownName("glpi_plugin_genericobject_motherboardtypes",
                          ...
                          $data["contact_num"].
                        $data["contact"].
                        Dropdown::getDropdownName("glpi_plugin_genericobject_hddtypes",$data["plugin_genericobject_hddtypes_id"]).
                        Dropdown::getDropdownName("glpi_plugin_genericobject_processortypes",$data["plugin_genericobject_processortypes_id"]).
                        $data["size"].
              ...
              //       echo '&nbsp;';
             //    }
                 $show1=$show1."</td><td class='center'>";
