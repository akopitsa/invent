<?php
/*
 * @version $Id: dropdown.class.php 18175 2012-04-05 17:16:06Z remi $
 -------------------------------------------------------------------------
...
class Dropdown {
   ...
   **/
   ...
   static function showWorkArchive($name, $value="Work", $restrict_to=-1, $params=array()) {
   
       if ($restrict_to != "Work") {
           $options['Work'] = "Work";
       }
   
       if ($restrict_to != "Archived") {
