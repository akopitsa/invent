...
class PluginWebapplicationsWebapplication extends CommonDBTM {
   ...
   function getSearchOptions() {
      ...
      $tab[6]['field']         = 'db_location';
      $tab[6]['name']          = $LANG['plugin_webapplications'][27];
      ...
      $tab[81]['field']         = 'status';
      $tab[81]['name']          = $LANG['plugin_webapplications'][31];
      $tab[81]['datatype']      = 'itemlink';
      $tab[81]['massiveaction'] =  false;
      
      $tab[82]['table']         = $this->getTable();
      $tab[82]['field']         = 'db_name';
      $tab[82]['name']          = $LANG['plugin_webapplications'][26];
      
      $tab[83]['table']  = 'glpi_users';
      $tab[83]['field']  = 'name';
      $tab[83]['linkfield'] = 'programmer_id';
      $tab[83]['name']   = $LANG['plugin_webapplications'][28];
      
      $tab[84]['table']         = $this->getTable();
      $tab[84]['field']         = 'date_create';
      $tab[84]['name']          = $LANG['plugin_webapplications'][29];
      
      $tab[85]['table']  = 'glpi_locations';
      $tab[85]['field']  = 'name';
      $tab[85]['linkfield'] = 'locations_id';
      $tab[85]['name']   = $LANG['plugin_webapplications'][25];
   ...
   **/
   ...
   function showForm($ID, $options=array()) {
      ...
      echo "<tr class='tab_bg_1'>";
      //users
      echo "<td>".$LANG['plugin_webapplications'][30].": </td><td>";
      ...
      echo "<tr class='tab_bg_1'>";
      //programmer
      echo "<td>".$LANG['plugin_webapplications'][28].": </td><td>";
      User::dropdown(array('name' => "programmer_id",
      'value'  => $this->fields["programmer_id"],
      'entity' => $this->fields["entities_id"],
      'right'  => 'interface'));
      echo "</td>";
      //DataBase name
      echo "<td>".$LANG['plugin_webapplications'][26].": </td>";
      echo "<td>";
      Html::autocompletionTextField($this, "db_name", array('size' => "15"));
      echo "</td>";
      echo "</tr>";
      
      echo "<tr class='tab_bg_1'>";
      //Create Date
      echo "<td>".$LANG['plugin_webapplications'][29].": </td><td class='nopadding'>";
      Html::showDateFormItem("date_create",$this->fields["date_create"], 1, true, true);
      echo "</td>";
     
      //DataBase Location
      echo "<td>".$LANG['plugin_webapplications'][27].": </td>";
      echo "<td>";
      Html::autocompletionTextField($this, "db_location", array('size' => "35"));
      echo "</td>";
      echo "</tr>";
      ...
      echo "<tr class='tab_bg_1'>";
      //Work or archived
      echo "<td>".$LANG['plugin_webapplications'][31].": </td>";
      echo "<td>";
      Dropdown::showWorkArchive('status', $this->fields['status']);
      echo "</td>";
      //language of webapplications
      echo "<td></td>";
      echo "<td></td>";
