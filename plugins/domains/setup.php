      ...
      Plugin::registerClass('PluginDomainsDomain',
		...
		if ((isset($_SESSION["glpi_plugin_environment_installed"]) && $_SESSION["glpi_plugin_environment_installed"]==1)) {
			...
			if (plugin_domains_haveRight("domains","r")) {
				...
				$PLUGIN_HOOKS['submenu_entry']['environment']['options']['domains']['title'] = $LANG['plugin_domains']['title'][1];
...
function plugin_version_domains() {
	...
	return array (
		'name' => $LANG['plugin_domains']['title'][1],
		'version' => '1.5.1',
		'oldname' => 'domain',
		'license' => 'GPLv2+',
		'author'=>'Xavier Caillaud',
		'homepage'=>'https://forge.indepnet.net/wiki/domains',
